...
def ScoringModel(size_bi_lstm, size_feed_forward, size_edge_label, max_candidate_count):
    ...
    # Layers and models
    feature_model = FeatureModel(size_bi_lstm)
    ...
    feature_scoring_model = FeatureScoringModel(size_feed_forward, size_edge_label,
                                                get_feature_length(size_bi_lstm))
